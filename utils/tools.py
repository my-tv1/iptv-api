...
def get_epg_url():
    ...
    if os.getenv("GITHUB_ACTIONS"):
        ...
        return join_url(config.cdn_url, f"https://ghproxy.cfd/https://raw.githubusercontent.com/{repository}/{ref}/output/epg/epg.gz")
    else:
            ...
            for line in file:
                ...
                if trimmed_line != "":
                    if "#genre#" in trimmed_line:
                        ...
                        m3u_output += f'#EXTINF:-1 tvg-name="{processed_channel_name}" tvg-logo="{join_url(config.cdn_url, f'https://ghproxy.cfd/https://raw.githubusercontent.com/fanmingming/live/main/tv/{processed_channel_name}.png')}"'
                        if current_group:
